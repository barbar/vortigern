...
// import Header from './headerContainer.ts'
...
//   beforeEach(() => {
//     component = renderSmartComponent(Header, defaultState)
//   })
//   // Async example from the stars smart component
//   it('Renders Header', (done) => {
//     fetchMock.mock('https://api.github.com/repos/barbar/vortigern', githubMock.succuess)
//     const component = renderSmartComponent(Header, defaultState)
